# The GMT Dynamic Optics Simulation Guide

[Introduction](introduction.md)

 - [Getting Started](getting-started.md)
   - [Installation](getting-started/installation.md)
   - [DOS Interface](getting-started/dos-interface.md)

 - [Optical Model](optical-model.md)
   - [Installation](optical-model/installation.md)
   - [DOS Interface](optical-model/dos-interface.md)
